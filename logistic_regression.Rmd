...
To build the cost function, we first make a function to calculate the predicted
p values from a slope and intercept and the x-axis values we are predicting
from:
