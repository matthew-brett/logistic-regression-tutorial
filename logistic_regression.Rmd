...
illus.index = np.repeat('', len(illus))
illus
```

We have just seen that `odds_ratio = p / (1 - p)`. If there are no events of interest, then `p == 0` and the odds ratio is 0, as you can see from the first row of the dataframe above. 
