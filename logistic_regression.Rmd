...
`pp_of_label` values for labels of 1, and sets the remainder to 0.  Then we
...
plt.scatter(good_appetites['pp_of_1'], good_appetites['pp_of_label'], color = 'red', label = 'good appetite (1)')
plt.scatter(poor_appetites['pp_of_1'], poor_appetites['pp_of_label'], color = 'blue', label = 'poor appetite (0)')
