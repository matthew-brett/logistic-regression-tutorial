...
that $10^0$ is equal to 1. This is the case because the way we calculate divisions like $10^4/10^2$ is by subtracting the bottom exponent from the top exponent e.g. $10^4/10^2 = 10^{4-2} = 10^2$. 
